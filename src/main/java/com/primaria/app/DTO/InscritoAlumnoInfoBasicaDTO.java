...
public class InscritoAlumnoInfoBasicaDTO {
    ...
    public InscritoAlumnoInfoBasicaDTO(String alumnoId, String nombre, String apellidoPaterno, String apellidoMaterno,
                                       String matricula, String curp, String gradoId, String gradoNombre,
                                       String grupoId, String grupoNombre, Estatus estatus) {
